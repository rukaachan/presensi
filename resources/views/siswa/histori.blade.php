...
@section('judul', 'Histori presensi')
@section('page-description', 'Telusuri catatan kehadiran Anda berdasarkan bulan dan minggu.')

@section('isi')
    <section class="history-workspace" aria-labelledby="history-title">
        <header class="history-heading">
            <div>
                <p class="eyebrow">Catatan pribadi</p>
                <h2 id="history-title">Riwayat kehadiran Anda.</h2>
            </div>
        ...
        <div class="table-scroll" tabindex="0" aria-label="Tabel histori presensi">
...
@section('footer')
    <script type="module">
        document.getElementById('downloadPDF')?.addEventListener('click', () => {
            ...
            if (!form) return;
            form.action = '{{ route('siswa.presensi.pdf') }}';
            form.submit();
        });
    </script>
@endsection
